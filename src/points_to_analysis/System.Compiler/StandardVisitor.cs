...
namespace System.Compiler{
  ...
  class StandardVisitor: Visitor{
    ...
    public override Node Visit(Node node){
      ...
      switch (node.NodeType){
        ...
        case NodeType.EnsuresFinally:
          return this.VisitEnsuresFinally((EnsuresFinally)node);
    ...
    public virtual EnsuresFinally VisitEnsuresFinally (EnsuresFinally e) {
      if (e == null) return null;
      e.PostCondition = this.VisitExpression(e.PostCondition);
      return e;
    }
