...
namespace System.Compiler{
  ...
  class Duplicator : StandardVisitor{
    ...
    public override EnsuresFinally VisitEnsuresFinally (EnsuresFinally e) {
      if (e == null) return null;
      return base.VisitEnsuresFinally((EnsuresFinally)e.Clone());
    }
    ...
    protected virtual void ProvideMethodAttributes(Method/*!*/ dup, object/*!*/ handle) {
      ...
      TypeNode savedTargetType = this.TargetType;
      this.TargetType = dup.DeclaringType;
      if (tattributes != null) dup.Attributes = this.VisitAttributeList(tattributes);
      if (tSecurityAttributes != null) dup.SecurityAttributes = this.VisitSecurityAttributeList(tSecurityAttributes);
      this.TargetType = savedTargetType;
    }
