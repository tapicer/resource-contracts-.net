  ...
  public abstract class StandardDoubleVisitor: DoubleVisitor{
    ...
    public override Node Visit(Node node1, Node node2){
      ...
      switch (node1.NodeType){
        ...
        case NodeType.EnsuresFinally:
          return this.VisitEnsuresFinally((EnsuresFinally)node1, node2 as EnsuresFinally);
    ...
    public virtual EnsuresFinally VisitEnsuresFinally (EnsuresFinally e1, EnsuresFinally e2) {
      if (e1 == null) return null;
      if (e2 == null)
        e1.PostCondition = this.VisitExpression(e1.PostCondition, null);
      else
        e1.PostCondition = this.VisitExpression(e1.PostCondition, e2.PostCondition);
      return e1;
    }
